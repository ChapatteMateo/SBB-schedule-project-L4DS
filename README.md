...
1. If you wish to go trough the whole process including derivation of the different datasets, then start by running the instructions in `SetupTables`. This will create the required tables on your personnal HDFS space (in icc cluster: requires you to have access and be connected to EPFL's VPN).
